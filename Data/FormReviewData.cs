...
{
    public class FormReviewData : BaseData
    {
        public DataSet ViewFormReviewData(FormReview formreview)
        {
            ...
            try
            {
                ...
                string parameterValue = ObjectHelper.GetXMLFromObject(formreview);
                ...
                dataSet.Tables[0].TableName = "FormReview";
            }
            catch (Exception)
            {
                throw;
